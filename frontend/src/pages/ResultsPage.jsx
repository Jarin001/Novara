...
const ResultsPage = () => {
  ...
  // NEW: Cache for paper-in-library checks
  ...
  // FIXED: Check if paper is already saved in libraries - USING CORRECT BACKEND ENDPOINTS
  // FIXED: Check if paper is already saved in libraries - USING CORRECT BACKEND ENDPOINTS
...
const openSave = async (item) => {
  ...
  // SAVE PAPER TO LIBRARIES - CORRECTED FOR YOUR BACKEND
  // SAVE PAPER TO LIBRARIES - CORRECTED FOR YOUR BACKEND
